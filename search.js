...
let loadPage = function (listOfSearch) {
  ...
  for (i = 0; i < 6; i++) {
    albumSearch.innerHTML += `
    <a class="col-2" href="album.html?q=${listOfSearch.data[i].album.id}"><div class="col-12"> <div class="searchCard"><img class="cardImage" src=${listOfSearch.data[i].album.cover_medium}>
